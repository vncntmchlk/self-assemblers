...
# circle
circle = cv2.circle(blank_image, center_coordinates, 40, color, thickness)
circle = cv2.circle(circle, center_coordinates, 60, color, thickness)
circle = cv2.circle(circle, center_coordinates, 80, color, thickness)
